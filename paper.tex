...
\acmConference[DIS'22]{DIS 2022}{June 13--June 17, 2022}{Online conference}
\acmBooktitle{DIS '22: Proceedings of the 2022 ACM Designing Interactive Systems Conference}
\acmPrice{15.00}
...
\author{Manika Saha}
\email{manika.saha@monash.edu}
\affiliation{%
  \institution{Monash University}
  \city{Melbourne}
  \country{Australia}}

\author{Pratyasha Saha}
\email{pratyasha.saha1195@gmail.com}
\affiliation{%
...
\author{Gillian C. Oliver}
\email{gillian.oliver@monash.edu}
\affiliation{%
  \institution{Monash University}
  \city{Melbourne}
  \country{Australia}}
...
\renewcommand{\shortauthors}{Richardson et al.}
...
\keywords{values in design, design ethnography, values levers, digital civics}
